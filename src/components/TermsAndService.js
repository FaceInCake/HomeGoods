...
function TermsAndService (props) {
  ...
  const DATE = 'Augst 2, 2022';
  const COMPANY_COUNTRY = 'Canada';
  const WEBSITE_NAME = 'Home Goods';
  const COMPANY_INFORMATION = 'Home Goods Inc.';
  const WEBSITE_URL = 'homegoods.eppel.myweb.cs.uwindsor.ca';
  const WEBSITE_CONTACT_PAGE_URL = '/Contact';
  const WEBSITE_CONTACT_EMAIL = '';
  const COPYRIGHT_AGENT_CONTACT_EMAIL = '';
    ...
    <div className='TermsAndService'>
      <Card className='m-3 m-lg-5 p-lg-5'>
        <CardBody>
          ...
          <CardText>
            <p>Our Terms of Service were last updated on [{DATE}].</p>
            ...
            <li>
            <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to [{COMPANY_INFORMATION}].</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>"Website"</strong> refers to [{WEBSITE_NAME}], accessible from [{WEBSITE_URL}]</p>
            </li>
            <li>
            ...
            <p>You can contact our copyright agent via email ([{COPYRIGHT_AGENT_CONTACT_EMAIL}]). Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
